...
export default function Dashboard({ couple, onNavigate }) {
  return (
    <div style={{ minHeight: '100vh', background: 'var(--cream-soft)' }}>
      ...
      <div style={{
        ...
        <div style={{ maxWidth: '680px', position: 'relative' }}>
          ...
          <p className="fade-up delay-3" style={{
            ...
            color: 'var(--ink-muted)', lineHeight: 1.7, marginBottom: '36px',
            maxWidth: '420px',
          }}>
        ...
        {[
          ...
          <div key={i} style={{
            ...
            <div style={{
              ...
              {s.n}<span style={{ fontSize: '18px', color: 'var(--sapin-mid)' }}>{s.unit}</span>
            </div>
            <div style={{
              fontFamily: 'var(--font-sans)', fontSize: '11px',
      ...
      {/* Body */}
      <div style={{ padding: '48px', display: 'grid', gridTemplateColumns: '1fr 340px', gap: '32px', maxWidth: '1100px' }}>
        ...
        <div>
          <div style={{
            ...
            <span style={{ fontSize: '11px', color: 'var(--sapin-mid)', letterSpacing: '0.06em', cursor: 'pointer' }}>
              Tout voir →
            </span>
          </div>
          ...
          <div style={{ display: 'flex', flexDirection: 'column', gap: '0' }}>
            {sessions.map((s, i) => (
              ...
              >
                <div style={{
                  fontFamily: 'var(--font-sans)', fontSize: '11px',
                  color: 'var(--ink-faint)', minWidth: '52px',
                }}>
                  <div>{s.date}</div>
        ...
        {/* Side panel */}
        <div style={{ display: 'flex', flexDirection: 'column', gap: '16px', paddingTop: '52px' }}>
          {/* État du lien */}
          <div style={{
            background: 'var(--white)', border: '0.5px solid var(--border)',
            borderRadius: 'var(--radius)', padding: '20px',
          }}>
            <p style={{ fontSize: '10px', color: 'var(--ink-faint)', letterSpacing: '0.14em', textTransform: 'uppercase', marginBottom: '16px' }}>
              État du lien
            </p>
            <div style={{ display: 'flex', alignItems: 'center', justifyContent: 'space-between', marginBottom: '16px' }}>
              <div style={{ textAlign: 'center' }}>
                <Avatar letter="É" type="A" size={40} />
                <div style={{ fontSize: '11px', color: 'var(--ink)', marginTop: '6px', fontWeight: 500 }}>{couple.personA.name}</div>
                <div style={{ fontSize: '9px', color: 'var(--ink-faint)', marginTop: '2px' }}>Verbale-affective</div>
              </div>
              <div style={{ display: 'flex', flexDirection: 'column', alignItems: 'center', gap: '4px' }}>
                <div style={{ width: '32px', height: '0.5px', background: 'var(--sapin-mist)' }} />
                <div style={{ width: '6px', height: '6px', borderRadius: '50%', background: 'var(--sapin-mist)', animation: 'pulse 2s infinite' }} />
                <div style={{ width: '32px', height: '0.5px', background: 'var(--sapin-mist)' }} />
              </div>
              <div style={{ textAlign: 'center' }}>
                <Avatar letter="M" type="B" size={40} />
                <div style={{ fontSize: '11px', color: 'var(--ink)', marginTop: '6px', fontWeight: 500 }}>{couple.personB.name}</div>
                <div style={{ fontSize: '9px', color: 'var(--ink-faint)', marginTop: '2px' }}>Analytique-séq.</div>
              </div>
            </div>
          </div>
          ...
          <div style={{
            ...
            <p style={{ fontSize: '10px', color: 'var(--ink-faint)', letterSpacing: '0.14em', textTransform: 'uppercase', marginBottom: '14px' }}>
              Ce que Vnus a remarqué
            </p>
            {[
              ...
              <div key={i} style={{ marginBottom: i === 0 ? '14px' : 0, paddingBottom: i === 0 ? '14px' : 0, borderBottom: i === 0 ? '0.5px solid var(--border)' : 'none' }}>
                <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'baseline', marginBottom: '4px' }}>
                  <span style={{ fontSize: '12px', fontWeight: 500, color: 'var(--ink)' }}>{insight.title}</span>
                  <span style={{ fontSize: '11px', color: 'var(--sapin-mid)', fontFamily: 'var(--font-serif)' }}>{insight.score}</span>
                </div>
                <p style={{ fontSize: '11px', color: 'var(--ink-faint)', lineHeight: 1.5 }}>{insight.body}</p>
              </div>
            ))}
          </div>
        </div>
