/**
 * AI Provider — couche d'abstraction LLM
 * Pour changer de modèle : modifier uniquement ce fichier.
 * Interface : sendMessage(messages, systemPrompt) → string
 */

const ANTHROPIC_API_URL = 'https://api.anthropic.com/v1/messages'
const MODEL = 'claude-sonnet-4-20250514'

const VNUS_SYSTEM_PROMPT = `Tu es Vnus, une traductrice cognitive spécialisée dans les conflits relationnels.
